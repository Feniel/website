...
<head>
    ...
    <script type="text/JavaScript" src="includes/login/sha512.js"></script>
    <script type="text/JavaScript" src="includes/login/forms.js"></script>
</head>
<body>
<div id="nav">
    <div id="left">
...
<div id="login">
    ...
    <form action="includes/login/process_login.php" method="post" name="login_form">
